...
class PreActBasicBlock(nn.Module):
    ...
    def __init__(
        ...
        self.act1 = nn.ReLU(inplace=False) # CHANGED: inplace=True
        self.conv1 = conv3x3(inplanes, planes, stride)
        self.bn2 = norm_layer(planes)
        self.act2 = nn.ReLU(inplace=True)
        self.conv2 = conv3x3(planes, planes)
...
def resnet34(preact=False, **kwargs: Any) -> ResNet:
...
def resnet50(preact=False, **kwargs: Any) -> ResNet:
    ...
    """
    if preact:
        raise ValueError('ResNet50 currently doesnt, support the pre-activation structure.')
